...
function Team() {
  ...
  return (
    <>
      <div className="relative w-full" style={{ background: "linear-gradient(109.6deg, rgb(255, 230, 109) 11.2%, rgb(87, 232, 107) 100.2%)", borderRadius: '20px', margin: '15px', padding: '20px', backdropFilter: 'blur(10px)' }}>
...
<span class="font-bold text-xl">Food App</span>
          ...
          <div className={`lg:flex ${isOpen ? 'block' : 'hidden'} w-full lg:w-auto`}>
            <ul className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-8">
              <li className="text-xl font-bold">
                <NavLink to="/register" className={({ isActive }) => isActive ? "text-red-600" : "text-gray-800"}>
              ...
              <li className="text-xl font-bold">
                <NavLink to="/signin" className={({ isActive }) => isActive ? "text-red-600" : "text-gray-800"}>
                  Sign-Up
                </NavLink>
              </li>
              <li className="text-xl font-bold">
      ...
      <div className="" style={{ backgroundImage: "url(https://as2.ftcdn.net/v2/jpg/07/35/30/21/1000_F_735302142_1pcWmiMMpavDtncZtyzRFdoza42Z0XwW.jpg)", backgroundSize: 'cover', backgroundRepeat: "no-repeat" }}>
        <div className="flex flex-col items-center justify-center min-h-screen">
          <div className="max-w-2xl text-center" style={{ background: "linear-gradient(109.6deg, rgb(255, 230, 109) 11.2%, rgb(87, 232, 107) 100.2%)", opacity: "50px", borderRadius: '20px', margin: '30px', padding: '20px', backdropFilter: 'blur(10px)' }}>
            <h1 className="text-4xl font-bold mb-4">Welcome to Your Website</h1>
            <p className="text-lg mb-8">A place where dreams come true</p>
            <a href="#" className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded-full">Get Started</a>
          </div>
        </div>
      </div>
    </>
